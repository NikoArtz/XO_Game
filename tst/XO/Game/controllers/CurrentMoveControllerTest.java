...
public class CurrentMoveControllerTest {
    ...
    @Test
    public void TestCurrentMoveWhenNextTurnIsO() throws Exception {
    ...
    @Test
    public void TestCurrentMoveWhenNextTurnIsX() throws Exception {
        final CurrentMoveController currentMoveController = new CurrentMoveController();
        for(int i = 0; i < 3;i++) {
            final Field field = new Field(3);
            field.setFigure(new Point(i, 1), Figure.O);
    ...
    @Test
    public void TestCurrentMoveWhenNoNextTurn() throws Exception {
        final CurrentMoveController currentMoveController = new CurrentMoveController();
